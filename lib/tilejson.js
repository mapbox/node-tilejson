...
TileJSON.prototype.getTile = function(z, x, y, callback) {
    ...
    this.get(url, function(err, data, headers) {
        ...
        var responseHeaders = {};
        responseHeaders['Content-Type'] = headers['content-type'] || tiletype.headers(tiletype.type(data))['Content-Type'];
...
TileJSON.prototype.get = function(url, callback) {
    ...
    var opts = {
        ...
        agent: url.indexOf('https:') === 0 ? exports.httpsagent : exports.agent
    };
